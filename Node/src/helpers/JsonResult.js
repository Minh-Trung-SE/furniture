...
class JsonResult {
    ...
    static builder(httpStatus = HTTP_CODE.OK, code = HTTP_CODE.OK, payload, message = HTTP_REASON.OK, meta = null) {
        return new JsonResult(httpStatus, code, payload, message, meta)
    }

    /**
     * Send the response object to an Express.js response and set the provided HTTP headers.
     *
     * @param {import("express").Response} response - The Express.js response object to send the response to.
