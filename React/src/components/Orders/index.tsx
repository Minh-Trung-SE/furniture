...
const {accessor, display} = createColumnHelper<Order<Product>>();
...
const columns = [
        ...
        "status",
        {
            ...
            cell: ({getValue}) => {
                ...
                return status === "PENDING" ? (
                    ...
                    <Badge type="intent" intent="primary">Canceled</Badge>
                ) : null
            }
        }
    ),
    ...
    accessor(
        "attributes",
        {
            minSize: 450,
            header: "Address",
            cell: ({getValue}) => getValue().streetAddress
        }
    ),
    accessor(
        "updatedAt",
...
const OrderManage = () => {
    ...
    const table = useSimpleTable<Order<Product>>(
        order.data,
        columns
    )
    ...
    return (
        <div className="space-y-5">
            <div className="flex justify-between">
                <TableSearch<Order<Product>> table={table}/>
