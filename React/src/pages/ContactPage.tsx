const ContactPage = () => {
    return (
        ...
        <section className="flex items-center lg:h-screen font-poppins">
            <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto md:px-6">
                <div className="text-left py-10 space-y-2">
                    <h2 className="text-xl font-bold text-gray-800 md:text-3xl">
                        Let's Stay Connected
                    </h2>
                    <p className="text-sm">
                        Provide your information to receive dedicated support from us.
                    </p>
                </div>
                <div className="flex flex-wrap ">
                        ...
                        <div className="flex flex-wrap">
                            <div className="w-full px-4 mb-10 sm:w-1/2">
                                <div className="max-w-xs mx-auto">
                                    <div
                                        className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-blue-700 rounded-full">
                                        <svg
                            ...
                            <div className="w-full px-4 sm:w-1/2">
                                <div className="max-w-xs mx-auto">
                                    ...
                                    <a
                                        href="#"
                                        className="inline-block mr-8 text-blue-600-300 hover:text-blue-700"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={16}
                                    ...
                                    <a
                                        href="#"
                                        className="inline-block mr-8 text-blue-400-300 hover:text-blue-600"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={16}
                                    ...
                                    <a
                                        href="#"
                                        className="inline-block mr-8 text-blue-500 hover:text-blue-600-300"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={16}
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <form action="" className="p-6 bg-gray-50">
                            <div className="mb-6 ">
                                <label
                                    htmlFor="firstname"
                            ...
                            <button
                                className="px-4 py-2 font-medium text-gray-100 bg-blue-600 rounded shadow hover:bg-blue-700-700">
                                Send
                            </button>
                        </form>
                    </div>
